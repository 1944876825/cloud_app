...
const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$3]], ["__file", "D:/myitem/uniapp/轻影视/uni_modules/uview-plus/components/u-icon/u-icon.vue"]]);
const props = {
  props: {
    // 最小可选值
    min: {
...
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$2]], ["__file", "D:/myitem/uniapp/轻影视/uni_modules/uview-plus/components/u-slider/u-slider.vue"]]);
class Aliyun {
  constructor() {
    this.userInfo = {};
    this.file = {};
      ...
      createElementVNode("view", {
        ...
        createElementVNode("u-video", {
          ...
          createElementVNode("u-scalable", { style: { position: "absolute", left: "0", right: "0", top: "0", bottom: "0" } }, [
                ...
                $data.isFull && !$data.isLock ? (openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode("view", { style: { "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center" } }, [
                    ...
                    createElementVNode(
                      ...
                      toDisplayString($props.videoTitle + " " + $data.videoTopTitle),
                      1
                      /* TEXT */
                    )
                  ]),
              ...
              [
                ...
                $data.isFull && !$data.isLock ? (openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode("view", {
                    ...
                    createElementVNode(
                      ...
                      toDisplayString($data.videoCurrentTime),
                      1
                      /* TEXT */
                    ),
                    createVNode(_component_u_slider, {
                    ...
                    createElementVNode(
                      "u-text",
                      { style: { "color": "#fff", "font-size": "12px" } },
                      toDisplayString($data.videoDuration),
                      1
                      /* TEXT */
                    )
                  ]),
                ...
                !$data.isFull ? (openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode(
                    "u-text",
                    { style: { "color": "#fff", "font-size": "12px" } },
                    toDisplayString($data.videoCurrentTime) + "/" + toDisplayString($data.videoDuration),
                    1
                    /* TEXT */
                  ),
                  createElementVNode("view", {
            ...
            createCommentVNode(" 剧集 "),
            $data.isFull ? (openBlock(), createElementBlock(
              "cover-view",
              {
                key: 2,
              ...
              [
                $data.isShowJuJi ? (openBlock(), createElementBlock(
                  "view",
                  {
                    key: 0,
                    class: "",
                    ...
                    createElementVNode(
                      ...
                      [
                        (openBlock(true), createElementBlock(
                          Fragment,
                          null,
                          renderList($props.videoList, (vod, index) => {
                            return openBlock(), createElementBlock("view", {
                              class: "",
                              onClick: ($event) => $options.chooseJuJi(index)
                            }, [
                              vod && vod["ifShow"] ? (openBlock(), createElementBlock(
                                "view",
                                {
                                  key: 0,
                                ...
                                [
                                  $props.type == "0" ? (openBlock(), createElementBlock(
                                    "u-text",
                                    {
                                      key: 0,
                                      class: "",
                                    ...
                                    toDisplayString(vod["name"]),
                                    5
                                    /* TEXT, STYLE */
                                  )) : createCommentVNode("v-if", true),
                                  $props.type == "1" ? (openBlock(), createElementBlock(
                                    "u-text",
                                    {
                                      key: 1,
                                      class: "",
            ...
            $data.isFull ? (openBlock(), createElementBlock(
              ...
              [
                $data.isShowBeiSu ? (openBlock(), createElementBlock(
                  "view",
                  {
                    key: 0,
                    class: "",
            ...
            $data.isFull ? (openBlock(), createElementBlock(
              ...
              [
                $data.isShowJK ? (openBlock(), createElementBlock(
                  "view",
                  {
                    key: 0,
                    class: "",
                    ...
                    createElementVNode(
                      ...
                      [
                        (openBlock(true), createElementBlock(
                          Fragment,
                          null,
                          renderList($data.playUrlArr, (jk, index) => {
                            return openBlock(), createElementBlock("view", {
                              class: "",
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "D:/myitem/uniapp/轻影视/components/myVideoPlayer/myVideoPlayer.vue"]]);
            ...
            createElementVNode("view", {
              ...
              createElementVNode("view", { class: "flex-row" }, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList($data.myclass, (tab, tabItemIndex) => {
                    return openBlock(), createElementBlock("view", {
                      ...
                      createElementVNode("view", {
                        ...
                        tab.tip ? (openBlock(), createElementBlock(
                          "u-text",
                          {
                            key: 0,
          ...
          createVNode(_component_swiper, {
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($data.myclass, (page, childPageViewItemIndex) => {
                            ...
                            $data.tabIndex == 0 ? (openBlock(), createElementBlock("view", {
                              ...
                              createElementVNode("view", { class: "" }, [
                                createElementVNode(
                                  ...
                                  toDisplayString($data.videoInfo["name"]),
                                  1
                                  /* TEXT */
                                )
                              ]),
                              createElementVNode("view", {
                                ...
                                createElementVNode("view", { class: "" }, [
                                  createElementVNode(
                                    ...
                                    toDisplayString($data.videoInfo["pan_type"]),
                                    1
                                    /* TEXT */
                                  )
                                ]),
                                ...
                                createElementVNode("view", {
                                  ...
                                  createElementVNode("scroll-view", {
                                    ...
                                    (openBlock(true), createElementBlock(
                                      Fragment,
                                      null,
                                      renderList($data.videoList, (vod, index) => {
                                        return openBlock(), createElementBlock("view", {
                                          onClick: ($event) => $options.chooseJuJi(index)
                                        }, [
                                          vod && vod["ifShow"] ? (openBlock(), createElementBlock("view", {
                                            ...
                                            createElementVNode("view", { style: { "width": "200rpx" } }, [
                                              $data.type == "0" ? (openBlock(), createElementBlock(
                                                "u-text",
                                                {
                                                  key: 0,
                                              ...
                                              $data.type == "1" ? (openBlock(), createElementBlock(
                                                "u-text",
                                                {
                                                  key: 1,
                                                  style: normalizeStyle([{ color: $data.currentJuJi == index ? "#FB7299" : "#000" }, { "font-size": "13px", "text-align": "center" }])
...
const play = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "D:/myitem/uniapp/轻影视/pages/play/play.nvue"]]);
export {
  play as default
};
